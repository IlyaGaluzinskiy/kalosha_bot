...
async def process_help_command(message: types.Message):
    await message.reply("Tired of listening to the same artists? Write an artist you are interested in and i will suggest artists with similar vocabulary (lyrics)!")
...
# @dp.message_handler()
# async def error_message(content_type = 'any'):
#     await 
